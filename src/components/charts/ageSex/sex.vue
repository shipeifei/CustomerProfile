...
<div>
    ...
    <div id="user-sex-chart-container" class="chart-container" style="margin-top: -62px;"></div>
</div>
</template>
<script type="text/babel">
    ...
    export default {
        ...
        mounted() {
            var myChart = echarts.init(document.getElementById('user-sex-chart-container'));
           let option = {
                title: {
                    text: '',
                    x:'center'
